  ...
  public DutyReportsDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfDutyReport = new EntityInsertionAdapter<DutyReport>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `duty_reports` (`report_id`,`userid`,`custid`,`duty_id`,`date_in`,`date_out`,`signature`,`device_id`,`duty_report_id`,`sync_status`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
      }
