...
public final class ParkingDatabase_Impl extends ParkingDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(26) {
      @Override
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `chalk_comments` (`chalk_comment_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `chalk_id` INTEGER NOT NULL, `comment_id` INTEGER NOT NULL, `comment` TEXT, `is_private` TEXT DEFAULT 'N', `custid` INTEGER NOT NULL)");
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `duty_reports` (`report_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userid` INTEGER NOT NULL, `custid` INTEGER NOT NULL, `duty_id` INTEGER NOT NULL, `date_in` INTEGER, `date_out` INTEGER, `signature` TEXT, `device_id` INTEGER NOT NULL, `duty_report_id` TEXT, `sync_status` TEXT)");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '40b4201ec082c86e1a7552d3fc3f85ae')");
      }
    ...
    }, "40b4201ec082c86e1a7552d3fc3f85ae", "201561782531d759ab0bcad48a0d0d50");
