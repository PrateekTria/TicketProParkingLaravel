...
public final class GCMUtilities {
    ...
    public static boolean register(final Context context, final String regId) {
        ...
        new Thread(() -> {
            TPApplication app1 = (TPApplication) context.getApplicationContext();
            Log.i(TAG, "updateGCMRegistrationId: >>>>>>>>>>");
            Log.i(TAG, "getDeviceName: >>>>>>>>>>"+app1.getDeviceName());
            ServiceHandlerImpl service = new ServiceHandlerImpl();
            RequestPOJO requestPOJO1 = new RequestPOJO();
            Params params1 = new Params();
            params1.setDeviceIName(app1.getDeviceName());
            params1.setRegistrationId(regId);
            requestPOJO1.setParams(params1);
            requestPOJO1.setMethod("updateGCMRegistrationId");
            ApiRequest api1 = ServiceGenerator.createRxService(ApiRequest.class);
            Call<ResponseBody> gcm = api1.updateGCMRegistrationID(requestPOJO1);
