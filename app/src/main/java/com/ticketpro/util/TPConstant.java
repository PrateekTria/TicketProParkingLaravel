...
public class TPConstant {
    ...
    public static final String PRIVACY_POLICY = "https://info.ticketproweb.com/parking/privacypolicy.html";
    public static final String CONTACT_US = "https://info.ticketproweb.com/parking/contact-us.php";
    ...
    public static final String PREFS_KEY_STICKY_CHALK_PHOTO = "stickyChalkPhoto";
