...
//    public static void insertChalkComment(final ChalkComment ChalkComment) {
//        final ParkingDatabase instance = ParkingDatabase.getInstance(TPApplication.getInstance());
//
//        instance.chalkCommentsDao().insertChalkComment(ChalkComment).subscribeOn(Schedulers.io()).subscribeWith(new CompletableObserver() {
//            @Override
