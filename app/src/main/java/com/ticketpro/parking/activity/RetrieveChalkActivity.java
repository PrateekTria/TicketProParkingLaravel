...
public class RetrieveChalkActivity extends BaseActivityImpl{
	...
	public void downloadAction(View view){
		...
		for(ChalkVehicle chalk: chalks){
			...
			chalk.setDeviceId(chalk.getDeviceId());
			chalk.setUserId(chalk.getUserId());
        ...
        switch (id) {
            case FROM_DATE_DIALOG_ID:{
            	if (android.os.Build.VERSION.SDK_INT >22) {
					DatePickerDialog datePickerDialog=new DatePickerDialog(this,android.R.style.Theme_DeviceDefault_Light_Dialog, fromDateSetListener, myCalendar
            ...
            case FROM_TIME_DIALOG_ID:{
            	if (android.os.Build.VERSION.SDK_INT >22) {
            		return new TimePickerDialog(this,android.R.style.Theme_DeviceDefault_Light_Dialog,fromTimeSetListener,hour, minute, false);
            	}else
            ...
            case TO_DATE_DIALOG_ID:{
            	if (android.os.Build.VERSION.SDK_INT >22) {
					DatePickerDialog datePickerDialog=new DatePickerDialog(this,android.R.style.Theme_DeviceDefault_Light_Dialog, toDateSetListener, myCalendar
							.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
							myCalendar.get(Calendar.DAY_OF_MONTH));
            ...
            case TO_TIME_DIALOG_ID:{
            	if (android.os.Build.VERSION.SDK_INT >22) {
            		return new TimePickerDialog(this,android.R.style.Theme_DeviceDefault_Light_Dialog,toTimeSetListener,hour, minute, false);
            	}else
