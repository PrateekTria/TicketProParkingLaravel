...
public class PlateLookupListAdapter extends BaseExpandableListAdapter {
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		if(headerTitle.equalsIgnoreCase("HOTLIST")){
			llHeaderAccordion.setBackgroundResource(R.drawable.btn_green);

		}
		else if(headerTitle.equalsIgnoreCase("STOLEN")){
			llHeaderAccordion.setBackgroundResource(R.drawable.btn_deep_red);

		}
		else if(headerTitle.equalsIgnoreCase("ALERT")){
			llHeaderAccordion.setBackgroundResource(R.drawable.btn_deep_yellow);

		}else{
			llHeaderAccordion.setBackgroundResource(R.drawable.btn_yellow);
