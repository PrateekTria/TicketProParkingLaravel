...
//            });
            ...
            listView.setOnItemClickListener((parent, view, position, id) -> {
                ...
                if (position < filteredUsers.size()) {
                    TPApp.setUserInfo(filteredUsers.get(position));

                    Intent intent = new Intent(LoginSelectUserActivity.this, LoginPasswordActivity.class);
                    intent.putExtra("username", filteredUsers.get(position).getUsername());
                    intent.putExtra("password", filteredUsers.get(position).getPassword());
                    intent.putExtra("userid", filteredUsers.get(position).getUserId());
                    startActivity(intent);
                } else {
                    // Handle index out of bounds
                    Log.e("ListView", "Selected position is out of bounds.");
                }
            });
