...
import com.ticketpro.util.DownloadLogoTask;
...
public class HomeActivity extends BaseActivityImpl {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       //     permission = new TPMruntimePermission(true, HomeActivity.this);
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        case SYNC_SUCCESSFUL:
                            ...
                            Toast.makeText(getApplicationContext(), "Synchronized Database Successfully", Toast.LENGTH_SHORT).show();
        ...
        new Handler().postDelayed(() -> {
            ...
            try {
                if (deviceInfo != null && deviceInfo.getDevice() != null && deviceIdText != null ) {
                    ...
                    if(deviceInfo.getDevice().toString().equalsIgnoreCase("null")){
        ...
        try {
            ...
            if (!file.exists() && !customerInfo.getLogoImage().equals("null")) {
             ...
             // This code is changed by Prateek on 1/4/2024
               new DownloadLogoTask().execute(imageURL, TPUtility.getDataFolder() + customerInfo.getLogoImage());
