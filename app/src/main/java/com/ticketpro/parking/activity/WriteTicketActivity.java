...
*/
    ...
    private void __openPlacardListDialog() {
        ...
        for (int i = 0; i < strings.size(); i++) {
            ...
            Log.e("cleanedString>>>>" + i, cleanedString);
            strings.set(i, cleanedString);
        }
                ...
                public void onResponse(Call<ValidResult> call, Response<ValidResult> response) {
                    if (response.isSuccessful()) {
                       ...
                       /* JSONObject jsonObject = new JSONObject();
                        ...
                        if (response.body() != null && !response.body().getResult().getResult()) {
                            try {
...
//                    } else {
                    ...
                    if ((TPApplication.getInstance().getNetOnOff().isEmpty() && status) || (TPApplication.getInstance().getNetOnOff().equals("N") && status)) {
    ...
    private void createNewTicket() {
        ...
        voiceMemoBtn.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.mic));
    ...
    private void printTickets(Ticket printTicket, String printTemplateData, boolean printSpecialTemplate,
        ...
        if (printSpecialTemplate && printTicket.getTicketViolations().isEmpty()) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CAMERA_PERMISSION_REQUEST_CODE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                // Permission is granted, proceed with camera operations

            } else {
                requestCameraPermission();
                // Permission is denied, show an error message or request again
            }
        }
    }
