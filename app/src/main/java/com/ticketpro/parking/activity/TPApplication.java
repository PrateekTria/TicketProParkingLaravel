...
public class TPApplication extends MultiDexApplication {
    ...
    public boolean stickyChalkPhoto = false;
    ...
    private ArrayList<ChalkPicture> lastChalkPhotos = new ArrayList<>();
    public String IPSSpaceGroup = null;
    public String IPSSubArea = null;

    public ArrayList<ChalkPicture> getLastChalkPhotos() {
        return lastChalkPhotos;
    }

    public void setLastChalkPhotos(ArrayList<ChalkPicture> lastChalkPhotos) {
        this.lastChalkPhotos = lastChalkPhotos;
    }
    ...
    private ChalkVehicle sharedChalk;
    ...
    public ChalkVehicle getSharedChalk() {
        return sharedChalk;
    }

    public void setSharedChalk(ChalkVehicle sharedChalk) {
        this.sharedChalk = sharedChalk;
    }

    public Ticket createNewTicket() {
        Ticket ticket = new Ticket();
        try {
            if (this.deviceInfo != null && userInfo!=null) {
