...
public interface TicketsDao {
   ...
   /* @Query("Delete from tickets where date(ticket_date) < date('now','localtime')")
    ...
    @Query("SELECT * FROM tickets where status='PI' AND citation_number IN(:citation) order by citation_number ASC")
    List<Ticket> getCurrentPendingTicketsPI(int [] citation);
