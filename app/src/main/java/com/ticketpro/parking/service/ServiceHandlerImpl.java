...
public class ServiceHandlerImpl implements ServiceHandler {
    ...
    // This code is changed by Prateek 5/4/2024
    public JSONRPCClient getAppendServiceClient(String append) throws Exception {

        serviceClient = new JSONRPCSecureClient(TPConstant.SERVICE_URL + append);
        String featureValue = Feature.getFeatureValue(Feature.TIMEOUT);
        int i = 5000;
        if (featureValue != null && !TextUtils.isEmpty(featureValue)) {
            i = Integer.parseInt(featureValue) * 1000;
    ...
    public boolean syncDevices(JSONArray devices) {
        ...
        try {
            // Null or empty check for devices
            if (devices == null || devices.length() == 0) {
                Log.e(TAG, "Devices array is null or empty.");
               // sendError("Devices array is null or empty.");
                return false;
            }
            ...
            // Call the service
            JSONObject result = getAppendServiceClient("v1/parking/updateDevices").callJSONObject("updateDevices", params);
            Log.i(TAG, "updateDeviceInfo1: ");
            Log.i(TAG, "updateDeviceInfo: " + devices + result.toString());

            // Handle result
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError :updateDevices"));
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncUserSettings(JSONArray settings) {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/common/updateUserSettings").callJSONObject("updateUserSettings", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateUserSettings"));
                return false;
            } else {
                return true;
            }
    ...
    public JSONArray syncTickets(JSONArray tickets) throws JSONRPCException, Exception {
        ...
        JSONObject result = getAppendServiceClient("v1/parking/updateTickets").callJSONObject("updateTickets", params);
        if (!result.isNull("serviceError")) {
            return null;
        }
    ...
    public boolean syncUpdatesTickets(JSONArray tickets) {
        ...
        try {
            params.putOpt("tickets", tickets);
            JSONObject result = getAppendServiceClient("v1/parking/updateTicketChanges").callJSONObject("updateTicketChanges", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateTicketChanges"));
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncTicketComments(int violationId, JSONArray comments) {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateTicketComments").callJSONObject("updateTicketComments", params);
            if (!result.isNull("serviceError")) {
    ...
    public boolean syncTicketViolations(JSONArray violations) {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateTicketViolations").callJSONObject("updateTicketViolations", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateTicketViolations"));
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncTicketPictures(JSONArray pictures) {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateTicketPictures").callJSONObject("updateTicketPictures", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateTicketPictures"));
                return false;
            } else {
                return true;
            }
        ...
        if(chalks == null || chalks.length() == 0){
          return false;
            ...
            try {
                ...
                JSONObject result = getAppendServiceClient("v1/parking/updateChalks").callJSONObject("updateChalks", params);
                if (!result.isNull("serviceError")) {
                    sendError(result.getString("serviceError:updateChalks"));
                    return false;
                } else {
                    return true;
                }
    ...
    public boolean syncChalkPictures(JSONArray chalkPictures) {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateChalkPictures").callJSONObject("updateChalkPictures", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateChalkPictures"));
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncChalkComments(JSONArray chalkComments) {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateChalkComments").callJSONObject("updateChalkComments", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateChalkComments"));
                return false;
            } else {
                return true;
            }
    ...
    public boolean syncDutyReports(JSONArray dutyReports) {
        ...
        if(dutyReports == null || dutyReports.length() == 0){
            ...
            try {
                ...
                JSONObject result = getAppendServiceClient("v1/parking/updateDutyReports").callJSONObject("updateDutyReports", params);
                if (!result.isNull("serviceError")) {
                    sendError(result.getString("serviceError:updateDutyReports"));
                    return false;
                } else {
                    return true;
                }
    ...
    public boolean syncCallInReports(JSONArray callInReports) {
        ...
        if(callInReports == null || callInReports.length() == 0){
            ...
            try {
                ...
                JSONObject result = getAppendServiceClient("v1/parking/updateCallInReports").callJSONObject("updateCallInReports", params);
                if (!result.isNull("serviceError")) {
                    sendError(result.getString("serviceError:updateCallInReports"));
                    return false;
                } else {
                    return true;
                }
    ...
    public boolean syncHotListReports(JSONArray hotListReports) {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateHotListReports").callJSONObject("updateHotListReports", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateHotListReports"));
                return false;
            } else {
                return true;
            }
    ...
    public JSONObject getDeviceInfo(String deviceName) throws Exception {
        ...
        JSONObject object = getAppendServiceClient("v1/parking/getDeviceInfo").callJSONObject("getDeviceInfo", params);
    ...
    public JSONObject getClientInfo(int custId) throws Exception {
        ...
        JSONObject object = getAppendServiceClient("v1/common/getClientInfo").callJSONObject("getClientInfo", params);
    ...
    public JSONArray getUsers(int custId) throws Exception {
        JSONObject params = new JSONObject();
        params.putOpt("custId", custId);
        return getAppendServiceClient("v1/common/getUsers").callJSONArray("getUsers", params);
    }
    ...
    public JSONArray grtSpecialActivitieslocation(int custId, boolean fullSync) throws Exception {
        ...
        return getAppendServiceClient("v1/common/getSpecialActivitiesLocation").callJSONArray("getSpecialActivitiesLocation", params);
    ...
    public JSONArray getCustomers(int custId) throws Exception {
        JSONObject params = new JSONObject();
        params.putOpt("custId", custId);
        return getAppendServiceClient("v1/common/getCustomers").callJSONArray("getCustomers", params);
    }
    ...
    public JSONArray getMakesAndModels(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getModelsAndMakes").callJSONArray("getModelsAndMakes", params);
        return objects;
    }
    ...
    public JSONArray getDeviceGroup(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getDeviceGroup").callJSONArray("getDeviceGroup", params);
        return objects;
    }
    ...
    public JSONArray getBodies(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getBodies").callJSONArray("getBodies", params);
    ...
    public JSONArray getContacts(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getContacts").callJSONArray("getContacts", params);
    ...
    public JSONArray getColors(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getColors").callJSONArray("getColors", params);
    ...
    public JSONArray getFeatures(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getFeatures").callJSONArray("getFeatures", params);
    ...
    public JSONArray getLocations(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getLocations").callJSONArray("getLocations", params);
    ...
    public JSONArray getDuties(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getDuties").callJSONArray("getDuties", params);
        return objects;
    }
    ...
    public JSONArray getMessages(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getMessages").callJSONArray("getMessages", params);
    ...
    public JSONArray getHotlist(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getHotlist").callJSONArray("getHotlist", params);
    ...
    public JSONArray getMeters(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getMeters").callJSONArray("getMeters", params);
    ...
    public JSONArray getPermits(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getPermits").callJSONArray("getPermits", params);
    ...
    public JSONArray getStates(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getStates").callJSONArray("getStates", params);
    ...
    public JSONArray getViolations(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getViolations").callJSONArray("getViolations", params);
    ...
    public JSONArray getComments(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getComments").callJSONArray("getComments", params);
    ...
    public JSONArray getDirections(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getDirections").callJSONArray("getDirections", params);
    ...
    public JSONArray getStreetPrefixes(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getStreetPrefixes").callJSONArray("getStreetPrefixes", params);
        return objects;
    }
    ...
    public JSONArray getStreetSuffixes(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getStreetSuffixes").callJSONArray("getStreetSuffixes", params);
    ...
    public JSONArray getDurations(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getDurations").callJSONArray("getDurations", params);
    ...
    public JSONArray getUserSettings(int custId) throws Exception {
        ...
        JSONArray objects = null;
        params.putOpt("custId", custId);
        objects = getAppendServiceClient("v1/common/getUserSettings").callJSONArray("getUserSettings", params);
    ...
    public JSONArray getZones(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getZones").callJSONArray("getZones", params);
    ...
    public JSONArray getTicketComments(long citationNumber) throws Exception {
        ...
        objects = getAppendServiceClient("v1/common/getTicketComments").callJSONArray("getTicketComments", params);
    ...
    public JSONArray getTicketPictures(long citationNumber) throws Exception {
        ...
        JSONArray objects = null;
        params.putOpt("citationNumber", citationNumber);
        objects = getAppendServiceClient("v1/common/getTicketPictures").callJSONArray("getTicketPictures", params);
    ...
    public JSONArray getTicketViolations(long citationNumber) throws Exception {
        ...
        objects = getAppendServiceClient("v1/parking/getTicketViolations").callJSONArray("getTicketViolations", params);
    ...
    public JSONArray getChalkVehicles(int userId, int deviceId) throws Exception {
        ...
        objects = getAppendServiceClient("v1/common/getChalkVehicles").callJSONArray("getChalkVehicles", params);
    ...
    public JSONArray getChalkPictures(long chalkId) throws Exception {
        ...
        objects = getAppendServiceClient("v1/common/getChalkPictures").callJSONArray("getChalkPictures", params);
    ...
    public JSONArray getChalkComments(long chalkId) throws Exception {
        ...
        JSONArray objects = null;
        params.putOpt("chalkId", chalkId);
        objects = getAppendServiceClient("v1/common/getChalkComments").callJSONArray("getChalkComments", params);
    ...
    public JSONArray getTickets(int userId, int deviceId) throws Exception {
        ...
        params.putOpt("userId", userId);
        params.putOpt("deviceId", deviceId);
        objects = getAppendServiceClient("v1/common/getTickets").callJSONArray("getTickets", params);
    ...
    public JSONArray getGPSLocations(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getGPSLocations").callJSONArray("getGPSLocations", params);
    ...
    public User doLogin(String username, String password) throws Exception {
        ...
        JSONObject object = getAppendServiceClient("v1/parking/doLogin").callJSONObject("doLogin", params);
        if (object.isNull("serviceError")) {
    ...
    public JSONArray getVoidTicketReasons(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getVoidTicketReasons").callJSONArray("getVoidTicketReasons", params);
    ...
    public JSONArray getSpecialActivities(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getSpecialActivities").callJSONArray("getSpecialActivities", params);
    ...
    public JSONArray getSpecialActivityDispositions(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getSpecialActivityDispositions").callJSONArray("getSpecialActivityDispositions", params);
    ...
    public JSONArray getPrintMacros(int custId, boolean fullSync) throws Exception {
        ...
        try {
            params.putOpt("custId", custId);
            params.putOpt("fullSync", fullSync);
            objects = getAppendServiceClient("v1/common/getPrintMacros").callJSONArray("getPrintMacros", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONArray getPrintTemplates(int custId, boolean fullSync) throws Exception {
        ...
        try {
            params.putOpt("custId", custId);
            params.putOpt("fullSync", fullSync);
            objects = getAppendServiceClient("v1/common/getPrintTemplates").callJSONArray("getPrintTemplates", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONArray getCallInList(int custId, boolean fullSync) throws Exception {
        ...
        try {
            params.putOpt("custId", custId);
            params.putOpt("fullSync", fullSync);
            objects = getAppendServiceClient("v1/common/getCallInList").callJSONArray("getCallInList", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public boolean syncSpecialActivityReports(JSONArray specialActivityReports) {
        ...
        if(specialActivityReports == null || specialActivityReports.length() == 0){
            ...
            try {
                ...
                JSONObject result = getAppendServiceClient("v1/parking/updateSpecialActivityReports").callJSONObject("updateSpecialActivityReports", params);
                if (!result.isNull("serviceError")) {
                    sendError(result.getString("serviceError:updateSpecialActivityReports"));
                    return false;
                } else {
                    return true;
                }
    ...
    public boolean syncSpecialActivityPicture(JSONArray specialActivityReports) {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateSpecialActivityPictures").callJSONObject("updateSpecialActivityPictures", params);
            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateSpecialActivityPictures"));
                return false;
            } else {
                return true;
            }
                    ...
                    try {
						/*if(imagePath.contains("selfi")){
							uploadFlag = TPUtility.uploadFile(imagePath,
									TPConstant.SERVICE_URL + "/v1/common/uploadfile",
    ...
    public JSONArray searchMeters(int custId, String meter) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/searchMeters").callJSONArray("searchMeters", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
        return objects;
    ...
    public JSONArray searchPermits(int custId, String permit) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/searchPermits").callJSONArray("searchPermits", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONArray searchPlates(int custId, String plate, String state) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/searchPlates").callJSONArray("searchPlates", params);
    ...
    public JSONArray searchVins(int custId, String vin, String state) throws Exception {
        ...
        try {
            ...
            params.putOpt("state", state);
            objects = getAppendServiceClient("v1/parking/searchVins").callJSONArray("searchVins", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONArray searchPermitVins(int custId, String vin, String state) throws Exception {
        ...
        try {
            ...
            params.putOpt("vin", vin);
            params.putOpt("state", state);
            objects = getAppendServiceClient("v1/parking/searchPermitVins").callJSONArray("searchPermitVins", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONArray searchHotlist(int custId, String plate, String state) throws Exception {
        ...
        try {
            ...
            params.putOpt("plate", plate);
            params.putOpt("state", state);
            objects = getAppendServiceClient("v1/parking/searchHotlist").callJSONArray("searchHotlist", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONArray getTicketHistory(int custId, Date startDate, Date endDate) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/getTicketHistory").callJSONArray("getTicketHistory", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONArray getRepeatOffenders(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getRepeatOffenders").callJSONArray("getRepeatOffenders", params);
    ...
    public JSONArray getRepeatOffendersLive(String stateCode, String plate, int violationId) throws Exception {
       ...
       /* ApiRequest apiRequest = ServiceGenerator.createRxService(ApiRequest.class);
        ...
        objects = getAppendServiceClient("v1/parking/getRepeatOffendersLive").callJSONArray("getRepeatOffendersLive", params);
    ...
    public boolean updateRepeatOffendersCount(String stateCode, String plate, int violationId, int custId, String created_date) throws Exception {
        ...
        try {
            ...
            result = getAppendServiceClient("v1/parking/updateRepeatOffendersCount").callBoolean("updateRepeatOffendersCount", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
        return result;
    ...
    public boolean updateRepeatOffendersCount(RepeatOffenderParams repeatOffenderParams) throws Exception {
        ...
        //  RepeatOffender_Rpc requestPOJO = new RepeatOffender_Rpc();
        RepeatOffender_Rpc requestPOJO = new RepeatOffender_Rpc();
        requestPOJO.setMethod("v1/parking/updateRepeatOffendersCount");
    ...
    public JSONArray lastUpDateRepeatOffenders(ArrayList<RepeatOffender> repeatOffenders) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/lastUpDateRepeatOffenders").callJSONArray("lastUpDateRepeatOffenders", params);
        } catch (Exception e) {
            //log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONObject getGPSLocation(double lat, double lon) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/common/getGPSLocations").callJSONObject("getGPSLocations", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
        return objects;
    ...
    public JSONObject registerDevice(JSONObject device) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/registerDevice").callJSONObject("registerDevice", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONArray getLocationGroups(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getLocationGroups").callJSONArray("getLocationGroups", params);
    ...
    public JSONArray getLocationGroupLocations(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getLocationGroupLocations").callJSONArray("getLocationGroupLocations", params);
    ...
    public JSONArray getCommentGroups(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getCommentGroups").callJSONArray("getCommentGroups", params);
    ...
    public JSONArray getCommentGroupComments(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getCommentGroupComments").callJSONArray("getCommentGroupComments", params);
    ...
    public JSONArray getViolationGroups(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getViolationGroups").callJSONArray("getViolationGroups", params);
    ...
    public JSONArray getViolationGroupViolations(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getViolationGroupViolations").callJSONArray("getViolationGroupViolations", params);
    ...
    public JSONArray searchChalks(int custId, String plate, String state) throws Exception {
        ...
        try {
            ...
            params.putOpt("plate", plate);
            params.putOpt("state", state);
            objects = getAppendServiceClient("v1/parking/searchChalks").callJSONArray("searchChalks", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
        return objects;
    ...
    public JSONArray searchRepeatOffenders(int custId, String plate, String violation) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/searchRepeatOffenders").callJSONArray("searchRepeatOffenders", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
        return objects;
    ...
    public JSONArray searchPermitsByPlate(int custId, String plate, String state) throws Exception {
        ...
        try {
            ...
            params.putOpt("plate", plate);
            params.putOpt("state", state);
            objects = getAppendServiceClient("v1/parking/searchPermitsByPlate").callJSONArray("searchPermitsByPlate", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
        return objects;
    ...
    public boolean updateGCMRegistrationId(String deviceName, String registrationId) throws Exception {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateGCMRegistrationId").callJSONObject("updateGCMRegistrationId", params);
            if (!result.isNull("serviceError")) {
    ...
    public boolean sendErrorLog(ArrayList<ErrorLog> errors) throws Exception {
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateErrorLog").callJSONObject("updateErrorLog", params);
            if (!result.isNull("serviceError")) {
                return false;
            } else {
                return true;
    ...
    public boolean sendMobileNowLog(ArrayList<MobileNowLog> logs) throws Exception {
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateMobileNowLog").callJSONObject("updateMobileNowLog", params);

            if (!result.isNull("serviceError")) {
                sendError(result.getString("serviceError:updateMobileNowLog"));
                return false;
            } else {
                return true;
            }
    ...
    public JSONArray getUserChalks(int custId, int userId, Date fromDate, Date toDate, int durationId)
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/getUserChalks").callJSONArray("getUserChalks", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public boolean updateChalkStatus(long chalkId, String status, String dispositionReason) throws Exception {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateChalkStatus").callJSONObject("updateChalkStatus", params);
            if (!result.isNull("serviceError")) {
    ...
    public boolean deleteTicketComments(long citationNumber, int violationId, String comment) throws Exception {
        ...
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/deleteTicketComments").callJSONObject("deleteTicketComments", params);
            if (!result.isNull("serviceError")) {
    ...
    public boolean deleteTicketPicture(long citationNumber, String imageName) throws Exception {
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/deleteTicketPicture").callJSONObject("deleteTicketPicture", params);
            if (!result.isNull("serviceError")) {
    ...
    public boolean updateTicketPicture(long citationNumber, TicketPicture picture) throws Exception {
        try {
            ...
            JSONObject result = getAppendServiceClient("v1/parking/updateTicketPicture").callJSONObject("updateTicketPicture", params);
            if (!result.isNull("serviceError")) {
    ...
    public boolean sendEmail(String from, String[] to, String subject, String message) throws Exception {
        ...
        try {
            ...
            result = getAppendServiceClient("v1/parking/sendEmail").callBoolean("sendEmail", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONObject getValidTicket(int custId, long citationNumber) throws Exception {
        try {
            ...
            return getAppendServiceClient("v1/parking/getValidTicket").callJSONObject("getValidTicket", params);
    ...
    public JSONArray getVendors(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getVendors").callJSONArray("getVendors", params);
    ...
    public JSONArray getVendorServices(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getVendorServices").callJSONArray("getVendorServices", params);
    ...
    public JSONArray getVendorServiceRegistrations(int custId, int userId, int deviceId, boolean fullSync)
        ...
        params.putOpt("deviceId", deviceId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getVendorServiceRegistrations").callJSONArray("getVendorServiceRegistrations", params);
    ...
    public JSONArray getVendorItems(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getVendorItems").callJSONArray("getVendorItems", params);
    ...
    public JSONArray getModules(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getModules").callJSONArray("getModules", params);
    ...
    public JSONArray getCustomerModules(int custId, boolean fullSync) throws Exception {
        ...
        params.putOpt("custId", custId);
        params.putOpt("fullSync", fullSync);
        objects = getAppendServiceClient("v1/common/getCustomerModules").callJSONArray("getCustomerModules", params);
    ...
    public ArrayList<String> verifyAndSyncTickets(int custId, ArrayList<String> citations) throws Exception {
        ...
        try {
            ...
            JSONArray result = getAppendServiceClient("v1/parking/verifyAndSyncTickets").callJSONArray("verifyAndSyncTickets", params);
            if (result != null) {
    ...
    public boolean newHotList(Hotlist hotList) throws Exception {
        ...
        try {
            ...
            result = getAppendServiceClient("v1/parking/newHotlist").callBoolean("newHotlist", requestJSON);
    ...
    public JSONObject getVersionUpdates(int custId, String module) throws JSONException {
        ...
        try {
            result = getAppendServiceClient("v1/parking/getVersionUpdates").callJSONObject("getVersionUpdates", params);
    ...
    public JSONArray getLastUpdateRepeatOffender(int custid, String created_date) throws JSONException {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/getlastUpDateRepeatOffenders").callJSONArray("getlastUpDateRepeatOffenders", params);
    ...
    public JSONObject getEULA(int custId, int moduleId) throws Exception {
        ...
        try {
            result = getAppendServiceClient("v1/parking/getEula").callJSONObject("getEula", params);
        } catch (Exception e) {
            log.error(TPUtility.getPrintStackTrace(e));
        }
    ...
    public JSONObject updateEULAAcceptance(int userId, int recId, String isAcceptance, int custId) throws Exception {
        ...
        try {
            ...
            result = getAppendServiceClient("v1/parking/eulaAcceptance").callJSONObject("eulaAcceptance", params);
    ...
    public JSONArray getActivityList(int custId, String date) throws Exception {
        ...
        try {
            ...
            objects = getAppendServiceClient("v1/parking/getSpecialActivityReports").callJSONArray("getSpecialActivityReports", params);
    ...
    public boolean getPlacard(String agencyCode, String user, String plate, String placard, String source) throws Exception {
        ...
        try {
            ...
            result = getAppendServiceClient("v1/parking/GetLicenseDetail").callBoolean("GetLicenseDetail", params);
